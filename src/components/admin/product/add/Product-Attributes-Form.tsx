    ...
    <FormProvider {...form} >
      <div>
        <div className="space-y-2 mb-8">
          ...
          <p className="text-sm text-muted-foreground">Please fill out the form below to add brand & product attribute information for the product.</p>
        </div>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-bold line-clamp-1">Brand*</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-bold line-clamp-1">Category ID</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-bold line-clamp-1">Tags*</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
          ...
          <div >
            <div className="flex items-center justify-between mb-4">
              ...
              <Button
                ...
                className="bg-secondary text-white hover:bg-secondary/90 flex items-center gap-1"
              >
