...
export default function EditProductReturnPolicy() {
        ...
        <FormProvider {...form}>
            <div>
                <div className="space-y-2 mb-8">
                    ...
                    <p className="text-sm text-muted-foreground">Please fill out the form below to edit return policy  for the product.</p>
                </div>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className=" line-clamp-1">Return Period (Days)</FormLabel>
                                <FormControl>
                                    <Input
                                        type="number"
                        ...
                        render={({ field }) => (
                            <FormItem className="flex items-center justify-between space-x-2 rounded-lg border p-5 shadow-sm">
                                <div className="flex-1">
                                    <FormLabel className=" line-clamp-1">Returnable</FormLabel>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem >
                                <FormLabel className=" line-clamp-1">Return Policy Note</FormLabel>
                                <FormControl>
                                    <Textarea
