  ...
  return (
    <FormProvider {...form}>
      <div className="space-y-2 mb-8">
        <h1 className="text-xl font-bold">Edit Working Information</h1>
        <p className="text-sm text-muted-foreground">Please fill out the form below to edit working information for the employee.</p>
      </div>
      <form>
