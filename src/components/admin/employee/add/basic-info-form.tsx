...
export default function AddBasicInfoForm() {
    ...
    <FormProvider {...form}>
      <div className="">
        <div className="space-y-2 mb-8">
          ...
          <p className="text-sm text-muted-foreground">Please fill out the form below to add personal information for the employee.</p>
        </div>
