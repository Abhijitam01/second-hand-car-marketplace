    ...
    <FormProvider {...form}>
      <div className="">
        <div className="space-y-2 mb-8">
          <h1 className="text-2xl font-bold">Add Joining Date & Compensation</h1>
          <p className="text-sm text-muted-foreground">Please fill out the form below to add joining date & compensation for the employee.</p>
        </div>
